...
SIGNAL \inst1|boom3~combout\ : std_logic;
SIGNAL \inst1|inst4~combout\ : std_logic;
SIGNAL \ALT_INV_inst5~q\ : std_logic;
SIGNAL \inst1|ALT_INV_boom3~combout\ : std_logic;
SIGNAL \inst1|ALT_INV_inst40~combout\ : std_logic;
...
\inst1|ALT_INV_boom3~combout\ <= NOT \inst1|boom3~combout\;
\inst1|ALT_INV_inst40~combout\ <= NOT \inst1|inst40~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst1|ALT_INV_inst40~combout\,
	devoe => ww_devoe,
	o => \A~output_o\);
...
\inst1|inst40\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst1|boom3\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst1|inst4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst1|inst4~combout\ = (\inst6~q\) # (\inst5~q\)
