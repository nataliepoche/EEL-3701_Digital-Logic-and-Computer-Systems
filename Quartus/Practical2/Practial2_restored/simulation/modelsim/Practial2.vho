...
-- Equation(s):
-- \inst15~0_combout\ = \inst15~q\ $ (((!\Go_L~input_o\ & \Move~input_o\)))
...
-- Equation(s):
-- \inst36~0_combout\ = (!\Go_L~input_o\ & \Move~input_o\)
...
-- Equation(s):
-- \inst36~combout\ = (!\Go_L~input_o\ & (!\inst15~q\ & \Move~input_o\))
